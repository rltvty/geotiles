...
fn test_extreme_approximation() {
    ...
    println!(
        "High-detail sphere: {} tiles, {} natural shapes",
        hexasphere.tiles.len(),
        natural_shapes.shapes.len()
    );
    ...
    for target in extreme_tests {
        println!(
            "\n--- Ultra-aggressive approximation: {} shapes ---",
            target
        );
        ...
        let total_compression = hexasphere.tiles.len() as f64 / shapes.len() as f64;
        let natural_compression =
            hexasphere.tiles.len() as f64 / natural_shapes.shapes.len() as f64;
        ...
        println!(
            "  Additional compression: {:.1}x over natural",
